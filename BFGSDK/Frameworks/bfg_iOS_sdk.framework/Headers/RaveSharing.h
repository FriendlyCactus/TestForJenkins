...
+(void)tweet:(NSString *)tweet withCallback:(RaveCompletionCallback)callback;
+(void)tweet:(NSString *)tweet withImage:(UIImage *)image withCallback:(RaveCompletionCallback)callback;
