...
typedef void (^RaveConnectPluginCallback)(id<RaveConnectPlugin> plugin, NSError * error);
...
@protocol RaveAuthenticationManager <NSObject>
/**
 ...
 *  @param callback   A completion callback or nil if no notification is desired
 */
 ...
 *
 *  @param pluginKeyName  The named key for the plugin to use, e.g. "facebook"
 *  @param conflictResolutionPolicy  The conflict resolution policy to be used for the given plugin
 *  @param callback  A completion callback or nil if no notification is desired
 */
- (void)connectTo:(NSString *)pluginKeyName conflictResolutionPolicy:(id<RaveConflictResolutionPolicy>)conflictResolutionPolicy callback:(RaveCompletionCallback)callback;
 ...
 *  Data mirroring
 *
 *  Rave can automatically mirror common data like achievements and high scores to integrated plugins
 *  To enable such mirroring modify settings accordingly.
 *
 *  RaveSettings.DataMirror.Achievements is a comma separated list of plugins to mirror achievements.  Currently
 *  "GameCenter" is the only supported plugin.
 *
 *  RaveSettings.DataMirror.Leaderboards is a comma separated list of plugins to mirror leaderboards.  Currently
 *  "GameCenter" is the only supported plugin.
 */
 ...
 *
 *  @param merge policy The object implimenting the RaveMergePolicy protocol.
 */
