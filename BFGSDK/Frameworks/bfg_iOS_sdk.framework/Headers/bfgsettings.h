...
/// passed in type parameter don't match.
///
...
/// value and type parameter don't match or if no value is set for the key.
///
...
///
/// \return The value from settings, or nil if the object type of the retreived value and
/// the passed in type parameter don't match.
///
...
/// \brief This key is for a dictionary of settings for "Playhaven/Upsight". This is a placements tool.
...
/// \brief This key is for a dictionary of settings for "Kochava". This is a user-acquisition tool.
#define BFG_SETTING_KOCHAVA                             @"kochava"
...
/// \brief UA revenue reporting setting
///
/// \details Values: "none" (value of $0 is used; default), "uniform" (all purhcases report 1 unit of the local currency), "actual" (actual purchase values are reported)
///
/// \since 5.10
#define BFG_SETTING_UA_REVENUE_REPORTING_MODE           @"ua_revenue_reporting_mode"
