 ...
 *
 *  @param connected YES if the conflict was resolved and the user is connected, otherwise NO
 */
...
/** This method let's you set a dictionary of keys to map between Rave achievement keys and plugin specific keys.
 ...
 @param achievementKeyMap Dictionary mapping Rave achievement keys to plugin specific keys, or nil
 */
...
/** This method let's you set a dictionary of keys to map between Rave leaderboard keys and plugin specific keys.
 ...
 @param leaderboardKeyMap Dictionary mapping Rave leaderboard keys to plugin specific keys, or nil
 */
...
/** This method executes a share for the plugin
 ...
 @callback The callback indicates when the share request has been completed.  On success it should return a completed RaveShareRequest object, otherwse an error
 */
